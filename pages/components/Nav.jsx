...
export default function Nav() {
  return (
    <>
      <nav
        className={`fixed flex-col top-0 min-w-screen w-full inline-flex justify-center h-32 font-header bg-white/30 backdrop-blur`}
      >
      ...
      <div className="md:hidden block z-99">
        <CTA />
      </div>
    </>
  );
